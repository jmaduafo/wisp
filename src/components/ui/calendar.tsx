  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        head_cell:
          "opacity-70 rounded-md w-full font-normal text-[0.8rem]",
        ...
        day: 
          "size-7.5 p-0 font-normal aria-selected:opacity-100 hover:bg-white/15 rounded-md"
        ,
        day_range_start:
        ...
        day_outside:
          "day-outside opacity-40 aria-selected:text-muted-foreground",
