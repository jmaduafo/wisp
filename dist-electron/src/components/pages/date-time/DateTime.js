...
function DateTime() {
    ...
    return (_jsx(Widget, { className: "", children: day === "--" ? (_jsx(Loader, {})) : (_jsxs(_Fragment, { children: [_jsxs("div", { className: "flex justify-end gap-2.5 items-end", children: [_jsx("button", { onClick: () => setIs12(false), disabled: !is12, className: `${!is12
                                ...
                                : "text-[5vw] opacity-100"} leading-[1]`, children: "12" })] }), _jsx("div", { className: "w-full h-full flex items-center justify-center", children: _jsxs("div", { className: `flex ${is12 ? "gap-1" : "gap-5"}`, children: [_jsxs("div", { className: `flex items-start ${userData?.style === "default" ? "classic gap-2" : "elegant gap-0"}`, children: [_jsxs("div", { className: `${userData?.style === "default"
